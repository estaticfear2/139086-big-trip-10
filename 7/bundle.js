...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventsFilter; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class EventsFilter extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
        ...
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            <label class="event__label  event__type-output" for="event-destination-1">
              ${_const_js__WEBPACK_IMPORTED_MODULE_2__["eventTypeMap"][event.type]}
            </label>
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(event.startDate)} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(event.startDate)}">
            &mdash;
            <label class="visually-hidden" for="event-end-time-1">
              To
            </label>
            <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(event.endDate)} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(event.endDate)}">
          </div>
...
class TripEdit extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(event) {
    super();
    this._event = event;
  }
...
const createTripMarkup = (event) => {
  ...
  return (
    `<div class="event">
        ...
        <h3 class="event__title">${_const_js__WEBPACK_IMPORTED_MODULE_2__["eventTypeMap"][event.type]} ${event.city}</h3>
...
/* harmony import */ var _components_trip_events_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/trip-events-list.js */ "./src/components/trip-events-list.js");
...
/* harmony import */ var _components_events_filter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/events-filter.js */ "./src/components/events-filter.js");
...
const renderEvent = (event, tripEventsDayElement) => {
  ...
  const replaceEventEditComponent = () => {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(eventComponent, eventEditComponent);
  };

  const replaceEventComponent = () => {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(eventEditComponent, eventComponent);
  };

  const eventComponent = new _components_trip_js__WEBPACK_IMPORTED_MODULE_0__["default"](event);
  const eventEditComponent = new _components_trip_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](event);
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(tripEventsDayElement, eventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
};

class TripController {
  constructor(container, filters) {
    this._container = container;
    this._noEvents = new _components_no_events_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._eventsFilter = new _components_events_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"](filters);
    this._eventsList = new _components_trip_events_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  }
  ...
  render(events) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, new _components_trip_events_list_js__WEBPACK_IMPORTED_MODULE_2__["default"](dayList), _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
...
/* harmony import */ var _mock_main_filter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mock/main-filter.js */ "./src/mock/main-filter.js");
/* harmony import */ var _mock_site_menu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mock/site-menu.js */ "./src/mock/site-menu.js");
/* harmony import */ var _mock_events_filter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/events-filter.js */ "./src/mock/events-filter.js");
...
const menuItems = Object(_mock_site_menu_js__WEBPACK_IMPORTED_MODULE_6__["generateSiteMenu"])();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteControlsElement.firstElementChild, new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](menuItems), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTEREND);

const filters = Object(_mock_main_filter_js__WEBPACK_IMPORTED_MODULE_5__["generateMainFilters"])();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteControlsElement, new _components_main_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"](filters), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);

const tripEventsFilter = Object(_mock_events_filter_js__WEBPACK_IMPORTED_MODULE_7__["generateEventsFilter"])();
const tripEventsElement = document.querySelector(`.trip-events`);
const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripEventsElement, tripEventsFilter);

const eventsList = Object(_mock_trip_event_js__WEBPACK_IMPORTED_MODULE_8__["generateEventsList"])();
tripController.render(eventsList);

const tripInfoElement = siteMainElement.querySelector(`.trip-info`);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripInfoElement, new _components_trip_info_main_js__WEBPACK_IMPORTED_MODULE_3__["default"](eventsList), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripInfoElement, new _components_amount_js__WEBPACK_IMPORTED_MODULE_4__["default"](eventsList), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
...
const getSightPhoto = () => {
  return new Array(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomIntegerNumber"])(0, 8)).
  fill(``).
...
const generateRandArrayFromSubArray = (subArray, a, b) => {
  ...
  const commentsCount = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomIntegerNumber"])(a, Math.min(b, subArray.length));

  for (let j = 0; j < commentsCount; j++) {
    let indexComment = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomIntegerNumber"])(0, copySubArray.length - 1);
...
const getEventDate = () => {
  const startDate = new Date(Date.now() + Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomIntegerNumber"])(0, rangeEventDate));
  let endDate;

  const dur = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomIntegerNumber"])(1000 * 60 * 20, rangeEventDuration);
...
const generateEventPrice = () => {
  return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomIntegerNumber"])(PRICE_MIN, PRICE_MAX);
};

const generateEvent = () => {
  const [startDate, endDate] = getEventDate();
  return {
    type: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(EVENT_TYPE),
    city: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(CITIES),
    photo: getSightPhoto(),
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomArrayItem, getRandomNumber, getRandomIntegerNumber, formatDate, formatTime, getSetFromArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AmountComponent; });
...
class AmountComponent {
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["createElement"])(this.getTepmlate());
    }
...
/* harmony import */ var _components_amount_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/amount.js */ "./src/components/amount.js");
/* harmony import */ var _components_no_events_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/no-events.js */ "./src/components/no-events.js");
/* harmony import */ var _mock_main_filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mock/main-filter.js */ "./src/mock/main-filter.js");
/* harmony import */ var _mock_site_menu_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./mock/site-menu.js */ "./src/mock/site-menu.js");
/* harmony import */ var _mock_events_filter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./mock/events-filter.js */ "./src/mock/events-filter.js");
/* harmony import */ var _mock_trip_event_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mock/trip-event.js */ "./src/mock/trip-event.js");
...
const menuItems = Object(_mock_site_menu_js__WEBPACK_IMPORTED_MODULE_10__["generateSiteMenu"])();
Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(siteControlsElement.firstElementChild, new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](menuItems).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].AFTEREND);

const filters = Object(_mock_main_filter_js__WEBPACK_IMPORTED_MODULE_9__["generateMainFilters"])();
Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(siteControlsElement, new _components_main_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"](filters).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
...
const renderEvent = (event, tripEventsDayElement) => {
  ...
  const eventComponent = new _components_trip_js__WEBPACK_IMPORTED_MODULE_5__["default"](event);
  const eventEditComponent = new _components_trip_edit_js__WEBPACK_IMPORTED_MODULE_4__["default"](event);
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(tripEventsDayElement, eventComponent.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
};

const renderEvents = () => {
  const tripEventsFilter = Object(_mock_events_filter_js__WEBPACK_IMPORTED_MODULE_11__["generateEventsFilter"])();
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(tripEventsElement.firstElementChild, new _components_events_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripEventsFilter).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].AFTEREND);

  const dayList = Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["getSetFromArray"])(eventsList.map((it) => new Date(it.startDate).toDateString()));

  Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(tripEventsElement, new _components_trip_events_list_js__WEBPACK_IMPORTED_MODULE_3__["default"](dayList).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(tripInfoElement, new _components_trip_info_main_js__WEBPACK_IMPORTED_MODULE_6__["default"](eventsList).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].AFTERBEGIN);
};

const tripEventsElement = document.querySelector(`.trip-events`);
const eventsList = Object(_mock_trip_event_js__WEBPACK_IMPORTED_MODULE_12__["generateEventsList"])();

if (!eventsList.length) {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(tripEventsElement, new _components_no_events_js__WEBPACK_IMPORTED_MODULE_8__["default"]().getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
} else {
  renderEvents();
}

Object(_utils_js__WEBPACK_IMPORTED_MODULE_13__["render"])(tripInfoElement, new _components_amount_js__WEBPACK_IMPORTED_MODULE_7__["default"](eventsList).getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: render, RenderPosition, createElement, getRandomArrayItem, getRandomNumber, getRandomIntegerNumber, formatDate, formatTime, getSetFromArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
